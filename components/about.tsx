...
const statements = [
  "Match your skills with the perfect job opportunities.",
  "AI-powered resume analysis and career insights.",
  "Discover jobs tailored to your experience and goals.",
  "Prepare for interviews with intelligent research tools.",
  "Track your applications and optimize your career path.",
]
  ...
  return (
    <section ref={containerRef} className="relative py-32 overflow-hidden md:py-0">
      ...
      >
        ...
        <h2 className="font-sans text-3xl md:text-5xl font-light italic">Your Career Companion</h2>
      </motion.div>
