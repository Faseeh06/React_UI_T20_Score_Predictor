  ...
  return (
    <section ref={containerRef} className="relative h-screen w-full overflow-hidden bg-background">
      ...
      <motion.div style={{ opacity, scale }} className="relative z-10 h-full flex flex-col justify-between p-8 md:p-12 md:px-12 md:py-20">
        ...
        >
          <p className="font-mono text-xs tracking-[0.3em] text-muted-foreground mb-2">01 — CAREER</p>
        ...
        >
          <Link href="/signin">
            <motion.div
              ...
              whileTap={{ scale: 0.95 }}
              className="relative px-8 py-4 border border-border rounded-full font-mono text-sm tracking-widest uppercase bg-transparent backdrop-blur-sm hover:bg-foreground hover:text-background transition-colors duration-500 inline-block cursor-pointer"
            >
              Get Started
