  ...
  return (
    <section className="relative py-32 px-8 md:px-12 md:py-24">
      ...
      >
        ...
        <h2 className="font-sans text-3xl md:text-5xl font-light italic">Powerful Tools</h2>
      </motion.div>
