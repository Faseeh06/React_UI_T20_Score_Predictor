    ...
    <>
      ...
      >
        <nav className="flex items-center justify-between px-6 py-4 my-0 md:px-12 md:py-5">
          ...
          >
            <span className="font-mono text-xs tracking-widest text-muted-foreground">GULLI DANDA</span>
          ...
          <div className="hidden md:flex items-center gap-6">
            ...
            <Link href="/predictor">
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="relative px-6 py-2.5 border border-primary rounded-full font-mono text-xs tracking-widest uppercase bg-primary text-primary-foreground hover:bg-transparent hover:text-primary transition-colors duration-500"
              >
                Predictor
              </motion.button>
            </Link>
        ...
        {isMenuOpen && (
          ...
          >
            <nav className="flex flex-col items-center justify-center h-full gap-8">
              ...
              {/* Mobile Predictor Button */}
              <Link href="/predictor" onClick={() => setIsMenuOpen(false)}>
                <motion.button
                  initial={{ opacity: 0, y: 20 }}
                  animate={{ opacity: 1, y: 0 }}
                  exit={{ opacity: 0, y: 20 }}
                  transition={{ delay: 0.3 }}
                  className="px-8 py-3 border border-foreground/20 rounded-full font-mono text-sm tracking-widest uppercase bg-transparent hover:bg-foreground hover:text-background transition-colors duration-500 mt-4"
                >
                  Predictor
                </motion.button>
              </Link>
